                  ...
                  <>
                    <section>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        본 약관은 Wave X(이하 "회사")가 제공하는 Wave I(웨이브 아이, 이하 "서비스")의
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        ...
                        <p>3. 회사는 이용자의 대화 및 일기 데이터를 Wave X 자체 모델 학습 목적으로 사용하지 않습니다. 다만, 외부 AI API 제공자의 정책에 따라 일부 데이터가 해당 제공자의 모델 품질 개선 목적으로 활용될 수 있으며, 이 경우 각 제공자의 약관과 개인정보 처리방침이 함께 적용됩니다.</p>
                      </div>
                    </section>
                  ...
                  <>
                    ...
                    <section>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        responsibilities between Wave X (the “Company”) and users in connection
                        with the use of the Wave I (“Service”) provided by the Company, as well as
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        ...
                        <p>
                          ...
                          train Wave X&apos;s own AI models. However, depending on the policies of
                ...
                {language === 'ko' ? (
                  <>
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        <p>
                          Wave X(이하 "회사")는 Wave I(웨이브 아이, 이하 "서비스")를 제공함에 있어
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        ...
                        <p className="pt-2 pl-4">
                          회사는 수집한 데이터를 Wave X 자체 모델 학습(사내 AI 모델 훈련) 목적으로 사용하지 않습니다.
                  ...
                  <>
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        <p>
                          Wave X (hereinafter the "Company") values the protection of your
                          personal information when providing the Wave I service (hereinafter the
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        ...
                        <p className="pt-2 pl-4">
                          The Company does not use collected data to train Wave X&apos;s own AI
                    ...
                    <section>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-1">
                        ...
                        <p className="pl-4">- Responsible entity: Wave X</p>
